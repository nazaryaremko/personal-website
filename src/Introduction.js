...
function Introduction() {
    ...
    return (
        <div>
            <br/>
        <h1 id='home-move'  style={{color: '#605d74', padding: '20px', fontSize:'40px'}}>Home</h1>
            <hr id='hr0'/>
        <div id='introduction-container'>
            ...
            <div id='img-me'> <img style={{height:'350px', borderRadius: '5%', border: 'solid #605d74'}} src={me} alt='Picture of me'/> </div>
        </div>
        </div>
    )
}
